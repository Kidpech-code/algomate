...
final class SelectorHint {
  const SelectorHint({this.n, this.sorted, this.memoryBudgetBytes, this.preferStable, this.maxTimeComplexity});
  ...
  factory SelectorHint.large({bool? sorted, bool? preferStable}) => SelectorHint(n: 10000, sorted: sorted, preferStable: preferStable);
  ...
  @override
  int get hashCode => Object.hash(n, sorted, memoryBudgetBytes, preferStable, maxTimeComplexity);
  ...
  SelectorHint copyWith({int? n, bool? sorted, int? memoryBudgetBytes, bool? preferStable, String? maxTimeComplexity}) => SelectorHint(
    n: n ?? this.n,
