...
- Documentation and install snippet updates.
- All code formatted and static analysis passes.
...
- Manual edits to core logic, benchmark runner, and facade.
- CI workflow and benchmarking improvements.
- All tests and static analysis pass; formatting validated.
